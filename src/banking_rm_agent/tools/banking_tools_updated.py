...
class RemittanceStatusTool(BaseTool):
    ...
    def __init__(self):
        ...
        self.remittance_service = RemittanceService()
    ...
    def _run(self, customer_id: str, reference_id: Optional[str] = None) -> str:
        ...
        try:
            if reference_id:
                ...
                remittance = self.remittance_service.get_remittance_by_reference(
                ...
                remittances = self.remittance_service.get_customer_remittances(customer_id, limit=5)
